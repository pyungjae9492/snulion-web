...
export default function GalleryCard(props: GalleryCardProps) {
  ...
  return (
    <div className='h-[275px] max-w-[350px] overflow-hidden rounded-[10px] bg-white bg-opacity-10 md:h-[290px]'>
      ...
      <div className='flex flex-row items-center justify-between px-4 py-2.5 md:px-5'>
